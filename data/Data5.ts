const rarePersonae = ["Regent", "Queen's Necklace", "Stone of Scone", "Koh-i-Noor", "Orlov", "Emperor's Amulet", "Hope Diamond", "水晶骷髏"];
...
const arcana2Combos = [
    ...
    {'source': ['愚者',       'Magician'    ], 'result': 'Death'       },
    {'source': ['愚者',       'Priestess'   ], 'result': 'Moon'        },
    {'source': ['愚者',       'Empress'     ], 'result': 'Hanged Man'  },
    ...
    {'source': ['愚者',       'Hermit'      ], 'result': 'Priestess'   },
    ...
    {'source': ['愚者',       'Tower'       ], 'result': 'Empress'     },
    {'source': ['愚者',       'Star'        ], 'result': 'Magician'    },
    ...
    {'source': ['Magician',   '審判'   ], 'result': 'Strength'    },
    ...
    {'source': ['Priestess',  '戰車'     ], 'result': 'Hierophant'  },
    {'source': ['Priestess',  '正義'     ], 'result': 'Death'       },
    ...
    {'source': ['Priestess',  'Sun'         ], 'result': '戰車'     },
    {'source': ['Priestess',  '審判'   ], 'result': '正義'     },
    {'source': ['Empress',    'Empress'     ], 'result': 'Empress'     },
    {'source': ['Empress',    'Emperor'     ], 'result': '正義'     },
    {'source': ['Empress',    'Hierophant'  ], 'result': '愚者'        },
    {'source': ['Empress',    'Lovers'      ], 'result': '審判'   },
    {'source': ['Empress',    '戰車'     ], 'result': 'Star'        },
    {'source': ['Empress',    '正義'     ], 'result': 'Lovers'      },
    {'source': ['Empress',    'Hermit'      ], 'result': 'Strength'    },
    {'source': ['Empress',    'Fortune'     ], 'result': 'Hermit'      },
    {'source': ['Empress',    'Strength'    ], 'result': '戰車'     },
    {'source': ['Empress',    'Hanged Man'  ], 'result': 'Priestess'   },
    {'source': ['Empress',    'Death'       ], 'result': '愚者'        },
    ...
    {'source': ['Empress',    '審判'   ], 'result': 'Emperor'     },
    ...
    {'source': ['Emperor',    '審判'   ], 'result': 'Priestess'   },
    ...
    {'source': ['Hierophant', '審判'   ], 'result': 'Empress'     },
    ...
    {'source': ['戰車',    'Fortune'     ], 'result': 'Priestess'   },
    ...
    {'source': ['戰車',    'Sun'         ], 'result': 'Priestess'   },
    {'source': ['正義',    '正義'     ], 'result': '正義'     },
    {'source': ['正義',    'Hermit'      ], 'result': 'Magician'    },
